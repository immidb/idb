...
|US Immigration Court (EOIR) Integration|✅Yes. <br>• EOIR court site data integrated with database clients daily  <br>• View EOIR court calendar linked to database clients<br>• View EOIR court data by database client <br>• View recent changes to EOIR court data|⌧No|⌧No|
|Immigration Forms|See and select current USCIS forms|✅Yes. Via integration with [borderwise](https://www.borderwise.co/)|✅Yes|
|Online government forms filing / integration |Partial: Partially fill USCIS forms with client data. Ongoing integration|?|✅Yes. "e-filing" "e-file a range of forms directly on the government websites"|
|||||
